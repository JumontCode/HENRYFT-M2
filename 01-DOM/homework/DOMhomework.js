...
let createdSpan = document.querySelector('#createdBy');
createdSpan.innerHTML += ' Juan'
...
function buildToDo(todo, index) {
  ...
  // toDoText.setAttribute('class', index);
  if(todo.complete){toDoText.className = 'completeText'; checkBox.checked = true;}
...
function displayToDos() {
  ...
  let buildToDo = buildToDos(toDoItems);
  for(var i = 0; i < buildToDo.length; i++){
